...
export default {
  ...
  parameters: {
    cssProperties: {
      '--container-padding-block': 'var(--container-padding-block-start, var(--space-32)) var(--container-padding-block-end, var(--space-32))',
      '--container-padding-inline': 'var(--container-padding-inline-start, var(--space-20)) var(--container-padding-inline-end, var(--space-20))',
      ...
      '--container-tablet-padding-block': 'var(--container-tablet-padding-block-start, var(--space-48)) var(--container-tablet-padding-block-end, var(--space-48))',
      '--container-tablet-padding-inline': 'var(--container-tablet-padding-inline-start, var(--space-48)) var(--container-tablet-padding-inline-end, var(--space-48))',
      ...
      '--container-desktop-padding-block': 'var(--container-desktop-padding-block-start, var(--space-48)) var(--container-desktop-padding-block-end, var(--space-48))',
      '--container-desktop-padding-inline': 'var(--container-desktop-padding-inline-start, var(--space-64)) var(--container-desktop-padding-inline-end, var(--space-64))',
    },
  },
};
