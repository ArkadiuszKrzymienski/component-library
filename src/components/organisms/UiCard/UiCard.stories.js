...
export default {
  ...
  parameters: {
    ...
    cssProperties: {
      ...
      '--card-tablet-gap': '0',
      '--card-triage-padding-block': 'var(--card-triage-padding-block-start, var(--space-20)) var(--card-triage-padding-block-end, var(--space-20))',
      '--card-triage-padding-inline': 'var(--card-triage-padding-inline-start, var(--space-20)) var(--card-triage-padding-inline-end, var(--space-20))',
      ...
      '--card-tablet-triage-padding-block': 'var(--card-tablet-triage-padding-block-start, var(--space-40)) var(--card-tablet-triage-padding-block-end, var(--space-40))',
